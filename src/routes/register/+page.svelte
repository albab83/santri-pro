  ...
  async function handleRegister() {
    ...
    try {
      const res = await fetch(`${baseUrl}/api/auth/register`,{
        ...
        body: JSON.stringify({ nama, email, password }) // role = santri dari backend
      });
  ...
  <div class="w-full max-w-md">
    ...
    <div class="bg-white rounded-2xl shadow-xl p-8 space-y-6">
      ...
      <div class="text-center space-y-2">
        ...
        <h2 class="text-2xl font-bold text-gray-900">Daftar sebagai Santri</h2>
        <p class="text-gray-600">Buat akun baru untuk bergabung</p>
      </div>
      ...
      <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <ul class="text-xs text-blue-700 space-y-1">
          <li class="flex items-center">
            <svg class="h-3 w-3 text-blue-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
